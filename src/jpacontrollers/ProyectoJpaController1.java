...
public class ProyectoJpaController1 implements Serializable {
    ...
    public void create(Proyecto proyecto) throws PreexistingEntityException, Exception {
        ...
        if (proyecto.getReporteHistoricoList() == null) {
            proyecto.setReporteHistoricoList(new ArrayList<ReporteHistorico>());
        }
        ...
        try {
            ...
            for (ReporteHistorico reporteHistoricoListReporteHistoricoToAttach : proyecto.getReporteHistoricoList()) {
            ...
            proyecto.setReporteHistoricoList(attachedReporteHistoricoList);
            em.persist(proyecto);
            ...
            for (ReporteHistorico reporteHistoricoListReporteHistorico : proyecto.getReporteHistoricoList()) {
                Proyecto oldFiReporteHistoricoProyectoOfReporteHistoricoListReporteHistorico = reporteHistoricoListReporteHistorico.getFiReporteHistoricoProyecto();
                reporteHistoricoListReporteHistorico.setFiReporteHistoricoProyecto(proyecto);
                reporteHistoricoListReporteHistorico = em.merge(reporteHistoricoListReporteHistorico);
                if (oldFiReporteHistoricoProyectoOfReporteHistoricoListReporteHistorico != null) {
                    oldFiReporteHistoricoProyectoOfReporteHistoricoListReporteHistorico.getReporteHistoricoList().remove(reporteHistoricoListReporteHistorico);
                    oldFiReporteHistoricoProyectoOfReporteHistoricoListReporteHistorico = em.merge(oldFiReporteHistoricoProyectoOfReporteHistoricoListReporteHistorico);
                }
            }
    ...
    public void edit(Proyecto proyecto) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            List<ReporteHistorico> reporteHistoricoListOld = persistentProyecto.getReporteHistoricoList();
            List<ReporteHistorico> reporteHistoricoListNew = proyecto.getReporteHistoricoList();
            ...
            proyecto.setReporteHistoricoList(reporteHistoricoListNew);
            ...
            for (ReporteHistorico reporteHistoricoListOldReporteHistorico : reporteHistoricoListOld) {
                if (!reporteHistoricoListNew.contains(reporteHistoricoListOldReporteHistorico)) {
                    reporteHistoricoListOldReporteHistorico.setFiReporteHistoricoProyecto(null);
            ...
            for (ReporteHistorico reporteHistoricoListNewReporteHistorico : reporteHistoricoListNew) {
                if (!reporteHistoricoListOld.contains(reporteHistoricoListNewReporteHistorico)) {
                    Proyecto oldFiReporteHistoricoProyectoOfReporteHistoricoListNewReporteHistorico = reporteHistoricoListNewReporteHistorico.getFiReporteHistoricoProyecto();
                    reporteHistoricoListNewReporteHistorico.setFiReporteHistoricoProyecto(proyecto);
                    reporteHistoricoListNewReporteHistorico = em.merge(reporteHistoricoListNewReporteHistorico);
                    if (oldFiReporteHistoricoProyectoOfReporteHistoricoListNewReporteHistorico != null && !oldFiReporteHistoricoProyectoOfReporteHistoricoListNewReporteHistorico.equals(proyecto)) {
                        oldFiReporteHistoricoProyectoOfReporteHistoricoListNewReporteHistorico.getReporteHistoricoList().remove(reporteHistoricoListNewReporteHistorico);
                        oldFiReporteHistoricoProyectoOfReporteHistoricoListNewReporteHistorico = em.merge(oldFiReporteHistoricoProyectoOfReporteHistoricoListNewReporteHistorico);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            List<ReporteHistorico> reporteHistoricoList = proyecto.getReporteHistoricoList();
            for (ReporteHistorico reporteHistoricoListReporteHistorico : reporteHistoricoList) {
                reporteHistoricoListReporteHistorico.setFiReporteHistoricoProyecto(null);
                reporteHistoricoListReporteHistorico = em.merge(reporteHistoricoListReporteHistorico);
            }
            em.remove(proyecto);
            em.getTransaction().commit();
